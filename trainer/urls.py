...
urlpatterns = [
    ...
    path('activate_trainer/<int:pk>/', views.activate_trainer, name='activate-trainer'),
    path('inactivate_trainer/<int:pk>/', views.inactivate_trainer, name='inactivate-trainer'),
